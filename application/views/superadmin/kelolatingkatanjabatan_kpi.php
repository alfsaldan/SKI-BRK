        ...
        var tryRun = function() {
            ...
            $(function() {
                ...
                $(document).on('click', '.btn-atur-cabang', function() {
                    ...
                    $.getJSON('<?= base_url("superadmin/getKodeUnit/") ?>' + encodeURIComponent(kode_cabang), function(data) {
                ...
                function loadMapping(kode_unit) {
                    ...
                    $.getJSON('<?= base_url("superadmin/getMappingJabatan/") ?>' + kode_unit, function(data) {
                ...
                $(document).on('click', '.btn-hapus-mapping', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.post('<?= base_url("superadmin/hapusPenilaiMapping/") ?>' + id, function() {
                                Swal.fire(
                                    'Terhapus!',
                ...
                $('#formMapping').on('submit', function(e) {
                    ...
                    var url = id ? '<?= base_url("superadmin/editPenilaiMapping/") ?>' + id : '<?= base_url("superadmin/tambahPenilaiMapping") ?>';
