                    ...
                    <div class="card widget-box-two bg-success shadow-sm">
                        <div class="card-body">
                            ...
                            <div class="wigdet-two-content">
                                ...
                                <h2 class="text-white"><span data-plugin="counterup"><?= $total_users ?></span></h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card widget-box-two bg-info shadow-sm">
                        <div class="card-body">
                            ...
                            <div class="wigdet-two-content">
                                ...
                                <h2 class="text-white"><span data-plugin="counterup"><?= $statusCount['aktif'] ?></span></h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card widget-box-two bg-danger shadow-sm">
                        <div class="card-body">
                            ...
                            <div class="wigdet-two-content">
                                ...
                                <h2 class="text-white"><span data-plugin="counterup"><?= $statusCount['nonaktif'] ?></span></h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="card shadow-sm mb-4">
                        <div class="card-header bg-primary text-white">
                            <h6 class="mb-0"><i class="mdi mdi-chart-pie mr-2"></i> Distribusi Role User</h6>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-6">
                    <div class="card shadow-sm mb-4">
                        <div class="card-header bg-success text-white">
                            <h6 class="mb-0"><i class="mdi mdi-chart-donut mr-2"></i> Status Keaktifan User</h6>
                        </div>
                        <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="alert alert-warning shadow-sm">
                    ...
                    Terakhir diperbarui: <strong><?= date('d M Y H:i') ?></strong>
                </div>
            </div>
        </div>
    </div> <!-- content -->
