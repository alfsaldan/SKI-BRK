            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title text-primary"><i class="mdi mdi-account-badge-alert-outline mr-1"></i>
                            Program Peningkatan Kinerja (PPK)</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card shadow-sm border-0">
                        <div class="card-body">
                            <h4 class="header-title text-center mb-0 text-uppercase text-primary font-weight-bold">
                                Formulir Program Peningkatan Kinerja</h4>
                            <hr>
                            ...
                            <form action="<?= base_url('pegawai/simpan_ppk_penilai') ?>" method="post" id="form-ppk">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <h5 class="text-info mb-3"><i class="mdi mdi-account-details mr-1"></i> Data
                                            Pegawai</h5>
                                        ...
                                        <div class="form-group row mb-2">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control-plaintext" name="nik"
                                                    value="<?= isset($pegawai->nik) ? $pegawai->nik : '-' ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-2">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control-plaintext"
                                                    value="<?= isset($pegawai->jabatan) ? $pegawai->jabatan : '-' ?>"
                                                    readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-2">
                                            <label class="col-sm-4 col-form-label font-weight-medium">Unit
                                                Kantor</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control-plaintext"
                                                    value="<?= isset($pegawai->unit_kantor) ? $pegawai->unit_kantor : '-' ?>"
                                                    readonly>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 border-left">
                                        <h5 class="text-warning mb-3"><i class="mdi mdi-calendar-clock mr-1"></i>
                                            Periode Program</h5>
                                        <div class="form-group row mb-2">
                                            <label class="col-sm-4 col-form-label">PPK Tahap ke</label>
                                            <div class="col-sm-8">
                                                <input type="number" class="form-control" name="tahap"
                                                    placeholder="Masukkan tahap (misal: 1)"
                                                    value="<?= $ppk->tahap ?? '' ?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-2">
                                            <label class="col-sm-4 col-form-label">Periode PPK</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" name="periode_ppk"
                                                    value="<?= $ppk->periode_ppk ?? $periode_ppk_string ?>" readonly
                                                    required>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-2">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" name="periode_coaching"
                                                    placeholder="Contoh: ke-4"
                                                    value="<?= $ppk->periode_coaching ?? '' ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <h5 class="text-primary mb-3"><i class="mdi mdi-history mr-1"></i> Review Kinerja
                                    Sebelumnya</h5>
                                <div class="form-group">
                                    <label class="font-weight-bold">Hasil Evaluasi Kinerja Sebelumnya</label>
                                    <textarea class="form-control" name="review_sebelum" rows="3"
                                        placeholder="Deskripsikan hasil evaluasi kinerja sebelumnya..."><?= $ppk->review_sebelum ?? '' ?></textarea>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="target"
                                                placeholder="Target yang ditetapkan..."
                                                value="<?= $ppk->target ?? '' ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="aktivitas"
                                                placeholder="Aktivitas yang dilakukan..."
                                                value="<?= $ppk->aktivitas ?? '' ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <h5 class="text-primary mb-3"><i class="mdi mdi-bullseye-arrow mr-1"></i> Rencana dan
                                    Aktivitas Perbaikan</h5>
                                <div class="form-group">
                                    <label class="font-weight-bold">Rencana Tindakan untuk Mencapai Sasaran</label>
                                    <textarea class="form-control" name="rencana" rows="3"
                                        placeholder="Jelaskan rencana tindakan perbaikan..."><?= $ppk->rencana ?? '' ?></textarea>
                                </div>
                                        ...
                                        <tbody id="sasaran-body">
                                            <?php if (!empty($sasaran)): ?>
                                                <?php foreach ($sasaran as $index => $s): ?>
                                                    <tr>
                                                        ...
                                                        <td><input type="text" class="form-control" name="sasaran_bulan[]"
                                                                placeholder="Masukkan sasaran..."
                                                                value="<?= htmlspecialchars($s['sasaran_bulan'] ?? '') ?>"
                                                                required></td>
                                                        <td><textarea class="form-control" name="rincian_tindakan[]"
                                                                placeholder="Masukkan rincian tindakan..." rows="2"
                                                                required><?= htmlspecialchars($s['rincian_tindakan'] ?? '') ?></textarea>
                                                        </td>
                                            ...
                                            <?php else: ?>
                                                <tr>
                                                    ...
                                                    <td><input type="text" class="form-control" name="sasaran_bulan[]"
                                                            placeholder="Masukkan sasaran..." required></td>
                                                    <td><textarea class="form-control" name="rincian_tindakan[]"
                                                            placeholder="Masukkan rincian tindakan..." rows="2"
                                                            required></textarea></td>
                                                    <td class="text-center">
                                                        <button type="button" class="btn btn-danger btn-sm btn-remove"
                                                            disabled><i class="mdi mdi-trash-can"></i></button>
                                                    </td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                                ...
                                <?php if (!empty($ppk) && !empty($ppk->catatan_msdi)): ?>
                                    <h5 class="text-primary mb-3 mt-3"><i class="mdi mdi-comment-text-outline mr-1"></i>
                                        Catatan Divisi MSDI</h5>
                                ...
                                <h5 class="text-success mb-3"><i class="mdi mdi-check-decagram mr-1"></i> Status
                                    Verifikasi</h5>
                                        ...
                                        <div class="card border-secondary border h-100">
                                            <div class="card-body p-3 text-center d-flex flex-column">
                                                ...
                                                <div
                                                    ...
                                                    ?>
                                                    <span class="badge <?= $cls_pegawai ?> p-2"
                                                        style="font-size: 14px;"><?= $st_pegawai ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="card-body p-3 text-center d-flex flex-column">
                                                ...
                                                <div
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="checkbox" id="status_penilai1"
                                                            name="status_penilai1" value="Disetujui"
                                                            style="display:none;" <?= (isset($ppk->status_penilai1) && $ppk->status_penilai1 == 'Disetujui') ? 'checked' : '' ?>>

                                                        <!-- Area Tanda Tangan Interaktif -->
                                                        <div id="btn-signature"
                                                            class="d-flex flex-column align-items-center justify-content-center p-2"
                                                            style="border: 2px dashed #ccc; border-radius: 8px; cursor: pointer; min-height: 80px; transition: all 0.3s;">
                                                            <div
                                                                class="unsigned-content <?= (isset($ppk->status_penilai1) && $ppk->status_penilai1 == 'Disetujui') ? 'd-none' : '' ?>">
                                                                <i class="mdi mdi-draw text-primary"
                                                                    style="font-size: 2rem;"></i>
                                                                <div class="small text-muted mt-1">Klik untuk Tanda
                                                                    Tangan</div>
                                                            </div>
                                                            <div
                                                                class="signed-content <?= (isset($ppk->status_penilai1) && $ppk->status_penilai1 == 'Disetujui') ? '' : 'd-none' ?>">
                                                                <div class="text-success"
                                                                    style="font-family: 'Brush Script MT', cursive; font-size: 1.4rem; line-height: 1.2;">
                                                                    <?= isset($penilai->nama) ? $penilai->nama : 'Penilai I' ?>
                                                                </div>
                                                                <div class="small text-muted mt-1"
                                                                    style="font-size: 0.65rem;">Digitally Signed</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card border-secondary border h-100">
                                            <div class="card-body p-3 text-center d-flex flex-column">
                                                ...
                                                <div
                                                    ...
                                                    ?>
                                                    <span class="badge <?= $cls_msdi ?> p-2"
                                                        style="font-size: 14px;"><?= $st_msdi ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card border-secondary border h-100">
                                            <div class="card-body p-3 text-center d-flex flex-column">
                                                ...
                                                <div
                                                    ...
                                                    ?>
                                                    <span class="badge <?= $cls_pimpinan ?> p-2"
                                                        style="font-size: 14px;"><?= $st_pimpinan ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row mt-4">
                                    <div class="col-12 text-right">
                                        <a href="<?= base_url('pegawai/ppk_penilai') ?>"
                                            class="btn btn-secondary px-4"><i class="mdi mdi-arrow-left mr-1"></i>
                                            Kembali</a>
                                        <button type="submit" class="btn btn-primary px-4 ml-1"><i
                                                class="mdi mdi-content-save mr-1"></i> Simpan Formulir</button>
                                    </div>
                                </div>
