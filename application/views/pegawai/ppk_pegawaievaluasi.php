                            ...
                            <form action="" method="post">
                                ...
                                <div class="row mt-4">
                                    <div class="col-12 text-right">
                                        ...
                                        <button type="button" class="btn btn-primary"><i class="mdi mdi-content-save"></i> Simpan Evaluasi</button>
                                    </div>
                                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const employeeName = "<?= isset($pegawai->nama) ? htmlspecialchars($pegawai->nama, ENT_QUOTES, 'UTF-8') : '(Nama Pegawai)' ?>";
