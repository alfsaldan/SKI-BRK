                            ...
                            <form action="<?= base_url('pegawai/simpan_ppk_pimpinan') ?>" method="post" id="form-ppk">
                                            ...
                                            <div class="card-body p-3 text-center d-flex flex-column">
                                                ...
                                                <div
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="checkbox" id="status_pimpinanunit"
                                                            name="status_pimpinanunit" value="Disetujui"
                                                            style="display:none;" <?= (isset($ppk->status_pimpinanunit) && $ppk->status_pimpinanunit == 'Disetujui') ? 'checked' : '' ?>>
                                                        ...
                                                        <div id="btn-signature"
                                                            ...
                                                            <div
                                                                class="unsigned-content <?= (isset($ppk->status_pimpinanunit) && $ppk->status_pimpinanunit == 'Disetujui') ? 'd-none' : '' ?>">
                                                            ...
                                                            <div
                                                                class="signed-content <?= (isset($ppk->status_pimpinanunit) && $ppk->status_pimpinanunit == 'Disetujui') ? '' : 'd-none' ?>">
                                ...
                                <div class="row mt-4">
                                    <div class="col-12 text-right">
                                        <a href="<?= base_url('pegawai/ppk_penilai#pimpinan') ?>"
