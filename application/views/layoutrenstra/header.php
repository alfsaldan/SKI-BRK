...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="navbar-custom">
            ...
            <!-- LOGO -->
            <div class="logo-box">
                <a href="<?= base_url('administrator_renstra'); ?>" class="logo text-center">
                    <span class="logo-lg">
            ...
            <div class="slimscroll-menu">
                <div id="sidebar-menu">
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li class="<?= ($activeController == 'pegawai' && in_array($activeMethod, ['nilaipegawai', 'nilaipegawaidetail','nilaipegawaidetail'])) ? 'active' : '' ?>">
