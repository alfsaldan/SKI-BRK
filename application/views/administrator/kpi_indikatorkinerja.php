        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title"><i class="mdi mdi-target-account mr-2 text-primary"></i> Key Performance Indicator - KPI</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title mb-3">Filter KPI</h4>
                            <form action="<?= base_url('Administrator_Renstra/kpi_indikatorKinerja'); ?>" method="get">
                            ...
                            <div class="card-body">
                                ...
                                <form id="formSasaran" class="mb-4">
                                    ...
                                    <div id="sasaranWrapper" style="display:none;">
                                        ...
                                        <input type="text" name="sasaran_kpi" class="form-control" required>
                                    </div>
...
<script>
    ...
    document.getElementById('unit_kerja_filter').addEventListener('change', function() {
        ...
        if (unit_kerja) {
            fetch(`<?= base_url('Administrator_Renstra/getJabatanByUnit?unit_kerja='); ?>${unit_kerja}`)
    ...
    $(document).on('click', '.saveBtn', function() {
        ...
        $.ajax({
            url: "<?= base_url('Administrator_Renstra/updateIndikator'); ?>",
            method: "POST",
            data: {
                id: id,
                indikator: indikator,
                ...
                if (response.success) {
                    Swal.fire({
                        ...
                        <td class="text-center">
                            ...
                            <a href="<?= base_url('Administrator_Renstra/deleteIndikator/'); ?>${id}" class="btn btn-danger btn-sm deleteIndikatorBtn"><i class="mdi mdi-delete"></i></a>
                        </td>
                    `);
    ...
    $(document).on('click', '.saveSasaranBtn', function() {
        ...
        $.ajax({
            url: "<?= base_url('Administrator_Renstra/updateSasaran'); ?>",
            method: "POST",
            data: {
                id: id,
                sasaran: sasaran
    ...
    $("#submitSasaranBtn").on("click", function() {
        $.ajax({
            url: "<?= base_url('Administrator_Renstra/saveSasaranAjax'); ?>",
            method: "POST",
    ...
    $("#submitIndikatorBtn").on("click", function() {
        ...
        // Jika lolos, lanjut AJAX
        $.ajax({
            url: "<?= base_url('Administrator_Renstra/saveIndikatorAjax'); ?>",
            method: "POST",
    ...
    $(document).on("click", ".deleteBtn", function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?= base_url('Administrator_Renstra/deleteIndikatorAjax'); ?>",
                    method: "POST",
                    data: {
                        id: id
                    },
