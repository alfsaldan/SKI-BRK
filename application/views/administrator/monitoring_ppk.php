                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table id="table-monitoring-ppk"
                                class="table table-bordered table-striped display responsive nowrap table-centered"
                                style="width:100%">
                                <thead>
                                    <tr>
                                        <th>No</th>
...
<script src="<?= base_url('assets/libs/datatables/responsive.dataTables.min.js') ?>"></script>
