                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('Administrator/simpan_ppk_msdi') ?>" method="post" id="form-ppk">
                                ...
                                <div class="row mb-3">
                                        ...
                                        <div class="form-group row mb-2">
                                            ...
                                            <div class="col-sm-8">
                                                <p class="form-control-plaintext font-weight-bold mb-0">
                                                    <?= isset($pegawai->nama) ? $pegawai->nama : '-' ?></p>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-2">
                                            ...
                                            <div class="col-sm-8">
                                                <p class="form-control-plaintext mb-0">
                                                    <?= isset($pegawai->nik) ? $pegawai->nik : '-' ?></p>
                                                <input type="hidden" name="nik"
                                                    value="<?= isset($pegawai->nik) ? $pegawai->nik : '-' ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-2">
                                            ...
                                            <div class="col-sm-8">
                                                <p class="form-control-plaintext mb-0">
                                                    <?= isset($pegawai->jabatan) ? $pegawai->jabatan : '-' ?></p>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-2">
                                            ...
                                            <div class="col-sm-8">
                                                <p class="form-control-plaintext mb-0">
                                                    <?= isset($pegawai->unit_kantor) ? $pegawai->unit_kantor : '-' ?>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 border-left">
                                        ...
                                        <div class="form-group row mb-2">
                                            ...
                                            <div class="col-sm-8">
                                                <p class="form-control-plaintext mb-0">
                                                    <?= $ppk->periode_ppk ?? $periode_ppk_string ?></p>
                                                <input type="hidden" name="periode_ppk"
                                                    value="<?= $ppk->periode_ppk ?? $periode_ppk_string ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <p class="form-control-plaintext border rounded p-2 bg-light mb-0">
                                        <?= nl2br(htmlspecialchars($ppk->review_sebelum ?? '')) ?></p>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <p class="form-control-plaintext border rounded p-2 bg-light mb-0">
                                                <?= htmlspecialchars($ppk->pencapaian ?? '') ?></p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <p class="form-control-plaintext border rounded p-2 bg-light mb-0">
                                                <?= htmlspecialchars($ppk->aktivitas ?? '') ?></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <p class="form-control-plaintext border rounded p-2 bg-light mb-0">
                                        <?= nl2br(htmlspecialchars($ppk->rencana ?? '')) ?></p>
                                </div>
                                                ...
                                                <?php foreach ($sasaran as $index => $s): ?>
                                                    <tr>
                                                        ...
                                                        <td class="align-middle">
                                                            <?= htmlspecialchars($s['sasaran_bulan'] ?? '') ?></td>
                                                        <td class="align-middle">
                                                            <?= nl2br(htmlspecialchars($s['rincian_tindakan'] ?? '')) ?></td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            <?php else: ?>
                                                <tr>
                                ...
                                <div class="form-group mb-4">
                                    <textarea class="form-control" name="catatan_msdi" rows="3"
                                        placeholder="Tuliskan catatan evaluasi dari Divisi MSDI..."><?= $ppk->catatan_msdi ?? '' ?></textarea>
                                </div>
                                        ...
                                        <div class="card border-secondary border h-100">
                                            <div class="card-body p-3 text-center d-flex flex-column">
                                                ...
                                                <div
                                                    ...
                                                    ?>
                                                    <span class="badge <?= $cls_penilai1 ?> p-2"
                                                        style="font-size: 14px;"><?= $st_penilai1 ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="card-body p-3 text-center d-flex flex-column">
                                                ...
                                                <div
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="checkbox" id="status_msdi" name="status_msdi"
                                                            value="Disetujui" style="display:none;"
                                                            <?= (isset($ppk->status_msdi) && $ppk->status_msdi == 'Disetujui') ? 'checked' : '' ?>>
                                                        ...
                                                        <div id="btn-signature"
                                                            ...
                                                            <div
                                                                class="unsigned-content <?= (isset($ppk->status_msdi) && $ppk->status_msdi == 'Disetujui') ? 'd-none' : '' ?>">
                                                            ...
                                                            <div
                                                                class="signed-content <?= (isset($ppk->status_msdi) && $ppk->status_msdi == 'Disetujui') ? '' : 'd-none' ?>">
                                ...
                                <div class="row mt-4">
                                    <div class="col-12 text-right">
                                        ...
                                        ?>
                                        <a href="<?= $kembali_url ?>" class="btn btn-secondary px-4"><i
