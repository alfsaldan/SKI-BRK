...
class MonitoringPegawai_model extends CI_Model
{
    /* ============================
    ...
    /**
     * 🔹 Autosave per baris realisasi
     *    - Simpan langsung saat user input realisasi
     *    - Nilai dibagi 12 (untuk per bulan)
     */
    public function simpanPenilaianBarisBulanan()
    {
        ...
        $existing = $this->db->get_where('monitoring_bulanan', [
            'nik' => $nik,
            'bulan' => $bulan,
            'tahun' => $tahun
        ])->row();
